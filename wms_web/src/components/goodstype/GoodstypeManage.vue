<template>
    <div>
      <div style="margin-bottom: 10px">
        ...
        ></el-input>
        <el-button type="primary" style="margin-left: 7px" @click="loadPost"
          >查询</el-button
        >
        <el-button type="success" @click="resetParam">重置</el-button>
        <el-button type="primary" style="margin-left: 7px" @click="add"
          >新增</el-button
        >
      </div>
      <el-table
  ...
  export default {
    ...
    methods: {
      ...
      del(id){
        this.$axios
              .get(this.$httpUrl + "/goodstype/delete?id="+id)
              .then((res) => res.data)
              .then((res) => {
                if (res.code == 200) {
                  this.$message({
      ...
      save() {
        this.$refs.form.validate((valid) => {
          if (valid) {
            this.$axios
              .post(this.$httpUrl + "/goodstype/saveOrMod", this.form)
              .then((res) => res.data)
              .then((res) => {
                if (res.code == 200) {
                  this.$message({
